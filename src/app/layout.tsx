...
export const metadata: Metadata = { title:"RecSys — Agent IA de recommandation personnalisee", description:"Boostez vos ventes avec des recommandations produits ultra-personnalisees. RecSys analyse le comportement de chaque visiteur et suggere les produits parfaits au bon moment." };
